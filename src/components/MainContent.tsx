...
export function MainContent({ categories, aboutContent, heroSlides, featuredLinks, configMap }: MainContentProps) {
  ...
  return (
    <>
      ...
      {/* Footer - 动态左边距 */}
      <footer className="relative border-t border-gray-200 dark:border-white/5 bg-gray-50 dark:bg-[#020617] text-gray-600 dark:text-gray-500 overflow-hidden transition-colors duration-300">
        {/* Grid Background */}
